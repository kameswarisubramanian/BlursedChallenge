...
var _passwordInputJs = require("./components/passwordInput.js");
var _passwordInputJsDefault = parcelHelpers.interopDefault(_passwordInputJs);
var _validatorJs = require("./components/validator.js");
var _validatorJsDefault = parcelHelpers.interopDefault(_validatorJs);
document.addEventListener('DOMContentLoaded', ()=>{
    const inputElement = document.getElementById('password-input');
    const passwordInput = new (0, _passwordInputJsDefault.default)(inputElement);
    ...
    passwordInput.onInputChange((password)=>{
        const validationResult = (0, _validatorJsDefault.default)(password);
        // Update feedback
    ...
    submitButton.addEventListener('click', ()=>{
        const validationResult = (0, _validatorJsDefault.default)(inputElement.value);
        submitAttempts++;
        if (validationResult.isValid) {
            if (submitAttempts < 3) {
                ...
                feedback.innerHTML = `
                    <h2>\u{1F389} Congratulations! \u{1F389}</h2>
...
},{"./components/passwordInput.js":"7hB9N","./components/validator.js":"jKdmH","@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT"}],"7hB9N":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
...
class PasswordInput {
    ...
    displayRules() {
        ...
        } else this.currentRuleIndex = 0; // Reset rules after displaying all
    }
}
...
},{}],"jKdmH":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
const evilRules = [
    ...
    {
        check: (p)=>p.length <= 12,
        msg: "Must be at most 12 characters"
    },
    {
        check: (p)=>/[A-Z]/.test(p),
        msg: "Must contain uppercase"
    },
    {
        check: (p)=>/[a-z]/.test(p),
        msg: "Must contain lowercase"
    },
    {
        check: (p)=>/\d/.test(p),
    ...
    {
        check: (p)=>!/(.)\1{2,}/.test(p),
        msg: "No repeating characters (3+ times)"
    },
    {
        check: (p)=>{
    ...
    {
        check: (p)=>p.length > 0 && p.charCodeAt(0) % 2 === 0,
        msg: "First character must have an even ASCII value"
    }
];
...
function validatePassword(password) {
    ...
    if (Math.random() > 0.85) strength = 100 - strength;
    ...
    return {
        ...
        message: isValid ? "Perfect! Now click submit..." : `${failed.length} rule(s) violated. Keep typing!`
    };
}

},{"@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT"}]},["7wZbQ","2R06K"], "2R06K", "parcelRequire90ef", {})

//# sourceMappingURL=blursed-password-app.0f77c784.js.map
